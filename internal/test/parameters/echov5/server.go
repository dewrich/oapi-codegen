//go:generate go run github.com/dewrich/oapi-codegen/v2/cmd/oapi-codegen --config=server.cfg.yaml ../parameters.yaml
//go:generate go run github.com/dewrich/oapi-codegen/v2/cmd/oapi-codegen --config=types.cfg.yaml ../parameters.yaml
//go:generate go run github.com/dewrich/oapi-codegen/v2/cmd/oapi-codegen --config=client.cfg.yaml ../parameters.yaml
