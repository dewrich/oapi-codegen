...
//go:generate go run github.com/dewrich/oapi-codegen/v2/cmd/oapi-codegen --config=config.base.yaml spec-base.yaml
//go:generate go run github.com/dewrich/oapi-codegen/v2/cmd/oapi-codegen --config=config.other.yaml spec-other.yaml
